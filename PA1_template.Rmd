...
The interval with maximum number of steps is `r intervals[max_interval]` (i.e. `r format(strptime(paste(rep(0,4-nchar(as.character(intervals[max_interval]))), as.character(intervals[max_interval]), sep=""),"%H%M"), format="%H:%M")`), with `r mean_steps_per_interval[max_interval]` steps.
